    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Humaira Jii</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Humaira Madam Ji's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
        ...
        <section className="teaser">
          <h2 id="teaserHeading">
            {birthdayReached
              ...
              : "✨ A special celebration for the most special person in my life ✨"}
          </h2>
          <p className="teaser-hint">Madam wait to karna padega aapko 9 Jan 12.00 AM tak 😁</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Aftab Jii 💖</h2>
