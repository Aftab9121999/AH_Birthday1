...
function MessageCard({ isActive }) {
  ...
  const message = `Humaira Jii,
  
Assalamuailakum Madam Jii, Wishing you the happiest birthday of your life 🥰😍🎊.
Allah aapko duniya ki har khushi se nawaze 🤲 aur aap humesha haste raho kyuki aap haste huye boht beautiful dikhte ho 🫣.
Aur Allah kare ki aap bas meri raho 😁.
Also Madam Jii ab na aap 20s mein aa gaye ho to na ab thode bade ho gaye ho aap 😁.
Aur haa sirf kuch mahineeee 😉.
